...
export function Skills(){
  const educations = [
    {
      name: "Ciência da Computação | Universidade Paulista"
    },
    {
      name: "Curso de Desenvolvimento JavaScript | Dev Samurai"
    },
    {
      name: "Pythonista Autodidata | Dev Aprender"
    }
  ]
        ...
        <div className="container mx-auto max-w-4xl p-4 py-12">
          <div className="relative mb-4 text-center">
            ...
            <p className="relative text-sm text-gray-700">
              Front-end Developer | React.js | TypeScript | Python | Looker Studio
            </p>
